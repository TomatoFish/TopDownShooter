...
namespace Game.UI
{
    public class DebugUnit : UIWidget
    {
        ...
        protected override string WidgetName => "DebugUnit";
        ...
        public DebugUnit(UIDocument uiDocument) : base(uiDocument)
        {
            _spawnPlayerButton = GetVisualElement<Button>("SpawnPlayer");
            _destroyPlayerButton = GetVisualElement<Button>("DestroyPlayer");
        }
